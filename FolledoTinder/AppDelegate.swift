...
//for the Parse server
        let config = ParseClientConfiguration { (theConfig) in //1
            theConfig.applicationId = "folledotindercloneappid" //1
            theConfig.server = "http://folledotinderserver.herokuapp.com/parse" //1
